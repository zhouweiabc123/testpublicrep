...
class TestQingWeng:
    ...
    def get_openId(self,get_age,new_tourist_data,mk_time):
        ...
        indexId = data[0]['game32dev']['indexId']
        ...
        param_json = {
            ...
            'sign': sign,
            'indexId': indexId,
            "envKey": data[0]['game32dev']['envKey'],
            'tsKey': data[0]['game32dev']['tsKey'],
            'snKey': data[0]['game32dev']['snKey'],
            'zoneKey': data[0]['game32dev']['zoneKey']
        }
        js = {
    ...
    def order_login(self):
        ...
        with allure.step("发送请求"):
            res = requests.post(url=self.configurl + data[0]['api'], json={
                "account": data[0]["game32dev"]['user'],
                "password": data[0]["game32dev"]['password'],
                "gameId": self.gameId,
                "apothecary_inexcusable_willful": None,
                "fast_shelve": None,
                "rhyme_systolic": None
    ...
    def test_14_creat_order(self, order_login, order_openId, mk_time, order_num, order_data):
        ...
        print(indexdata)
        indexId=indexdata[0]['game32dev']['indexId']
        #orderdata=None
        '''请问你为啥这么厉害'''
        ...
        gameOrderNo=order_num+order_data['devgame32']['gameOrderNo']
